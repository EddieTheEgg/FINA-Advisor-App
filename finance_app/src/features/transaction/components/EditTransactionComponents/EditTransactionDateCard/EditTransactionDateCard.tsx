...
import { styles } from './EditTransactionDateCard.styles';
import { colors } from '../../../../../styles/colors';
import { fontSize } from '../../../../../styles/fontSizes';
import FontAwesome6 from 'react-native-vector-icons/FontAwesome6';
import { useEditTransactionStore } from '../../../store/useEditTransactionStore';

export const EditTransactionDateCard = () => {
    const { dateDraft, setDateDraft } = useEditTransactionStore();
    ...
    const selectedDate = formatDateForCalendar(dateDraft);
